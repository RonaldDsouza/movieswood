  ...
  return (
    ...
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        ...
        <link rel='canonical' href='https://movieswood.vercel.app/page5' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Main Section 5 | Movieswood™' />
        <meta
        ...
        <meta property='og:url' content='https://movieswood.vercel.app/page5' />
