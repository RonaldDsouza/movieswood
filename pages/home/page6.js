...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://movieswood.vercel.app/page6',
  headline: 'Main Section 6 | Movieswood™',
  url: 'https://movieswood.vercel.app/page6',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'movies',
      item: 'https://movieswood.vercel.app/page6'
    }
  ]
})
...
const page6 = ({ items }) => {
  ...
  return (
    ...
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Main Section 6 | Movieswood™</title>
        <link rel='canonical' href='https://movieswood.vercel.app/page6' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Main Section 6 | Movieswood™' />
        <meta
        ...
        <meta property='og:url' content='https://movieswood.vercel.app/page6' />
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://movieswood.vercel.app/moviesp5.json')
