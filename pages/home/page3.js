...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://movieswood.vercel.app/page3',
  headline: 'Main Section 3 | Movieswood™',
  url: 'https://movieswood.vercel.app/page3',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'movies',
      item: 'https://movieswood.vercel.app/page3'
    }
  ]
})
...
const page3 = ({ items }) => {
  ...
  return (
    ...
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Main Section 3 | Movieswood™</title>
        <link rel='canonical' href='https://movieswood.vercel.app/page3' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Main Section 3 | Movieswood™' />
        <meta
        ...
        <meta property='og:url' content='https://movieswood.vercel.app/page3' />
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://movieswood.vercel.app/moviesp2.json')
