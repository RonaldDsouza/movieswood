...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://movieswood.vercel.app/page4',
  headline: 'Main Section 4 | Movieswood™',
  url: 'https://movieswood.vercel.app/page4',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'movies',
      item: 'https://movieswood.vercel.app/page4'
    }
  ]
})
...
const page4 = ({ items }) => {
  ...
  return (
    ...
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Main Section 4 | Movieswood™</title>
        <link rel='canonical' href='https://movieswood.vercel.app/page4' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Main Section 4 | Movieswood™' />
        <meta
        ...
        <meta property='og:url' content='https://movieswood.vercel.app/page4' />
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://movieswood.vercel.app/moviesp3.json')
