...
const page7 = ({ items }) => {
  ...
  const softwareSchema = JSON.stringify({
    ...
    headline: 'Main Section 7 | Movieswood™',
  ...
  const breadcrumbSchema = JSON.stringify({
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'movies',
        item: 'https://movieswood.vercel.app/page7'
      }
    ]
  })
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Main Section 7 | Movieswood™</title>
        ...
        <meta property='og:title' content=' Main Section 7 | Movieswood™' />
        <meta
