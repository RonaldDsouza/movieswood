...
const page9 = ({ items }) => {
  ...
  const softwareSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'Article',
    '@id': 'https://movieswood.vercel.app/page9',
    headline: 'Main Section 9 | Movieswood™',
    url: 'https://movieswood.vercel.app/page9',
    description:
  ...
  const breadcrumbSchema = JSON.stringify({
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'movies',
        item: 'https://movieswood.vercel.app/page9'
      }
    ]
  })
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Main Section 9 | Movieswood™</title>
        <link rel='canonical' href='https://movieswood.vercel.app/page9' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Main Section 9 | Movieswood™' />
        <meta
        ...
        <meta property='og:url' content='https://movieswood.vercel.app/page9' />
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://movieswood.vercel.app/moviesp7.json')
